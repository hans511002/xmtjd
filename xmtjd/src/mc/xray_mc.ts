class xray_mc extends std.MovieClip {
    ...
    public ray2Ene_cl: std.MovieClipSub = null;
    public ray2Cat_cl: std.MovieClipSub = null;
    ...
    public constructor() {
        ...
        this.ray2Ene_cl = new Cat(this.ray2, "ene_cl", "", 0);
        this.ray2Cat_cl = new Cat(this.ray2, "cat_cl", "", 0);
