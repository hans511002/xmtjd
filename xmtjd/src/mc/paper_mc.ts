class paper_mc extends std.MovieClip {
    ...
    public news_clCat1: std.MovieClipSub = null;
    public news_clCat2: std.MovieClipSub = null;
    ...
    public constructor() {
        ...
        this.news_clCat1 = this.news_cl.createMovieClipSub("cat1");
        this.news_clCat2 = this.news_cl.createMovieClipSub("cat2");
