module com.code {
    export class Menu extends std.BaseNode {
        cat1: cat_mc;
        cat2: cat_mc;
        clear_cl: SimpleButton;
        credits_cl: std.MovieClip;
        cup_1: std.MovieClip;
        cup_2: std.MovieClip;
        cup_3: std.MovieClip;
        cup_4: std.MovieClip;
        cup_5: std.MovieClip;
        deqaf_bt: SimpleButton;
        face_bt: std.MovieClip;
        go_sfk1: std.MovieClip;
        go_sfk2: std.MovieClip;
        go_sfk3: std.MovieClip;
        play_cl: SimpleButton;
        sounds_control_cl: Buttons_sounds2;
        zone_panel: std.MovieClip;
        _app: App;
        sure_cl: std.MovieClip;
        ...
        public init(): void {
            ...
            addEventListener(egret.Event.ENTER_FRAME, this.game_f);
            this.stage.addEventListener(egret.TouchEvent.TOUCH_TAP, click_f, this);
        ...
        public game_f(event: Event) {
            if (this.status == 0) {
                this.time_reload = this.time_reload + 1;
        ...
        public delete_f() {
            removeEventListener(egret.Event.ENTER_FRAME, this.game_f);
