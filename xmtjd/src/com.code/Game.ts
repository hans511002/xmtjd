module com.code {
    export class Game extends DataGame {
        ...
        public click_back_to_f(event: MouseEvent) {
            if (_mo(back_to_cl)) {
        ...
        public check_battle(param1, param2) {
        ...
        public check_end() {
            ...
            if (Main.sav.data.playoff == 0) {
                if (dead_fox == 4) {
                    let data = Main.sav.data;
                    let key = "team_games_" + this._app.team_enemy_id;
                    data[key] = data[key] + 1;
                    key = "team_d_" + this._app.team_enemy_id;
                    data[key] = data[key] + 1;
                    data["team_pts_" + this._app.team_enemy_id] = data["team_pts_" + this._app.team_enemy_id] + dead_cat;
                    data.last_enemy = this._app.team_enemy;
                    data.last_enemy_id = this._app.team_enemy_id;
                    var data = Main.sav.data;
                    var _loc_3 = data.team_games_1 + 1;
                    data.team_games_1 = _loc_3;
                    var data = Main.sav.data;
                    var _loc_3 = data.team_w_1 + 1;
                    data.team_w_1 = _loc_3;
                    data.team_pts_1 = data.team_pts_1 + dead_fox;
                    type_end = 1;
                    this.end_game();
                    if (data.league == 4) {
                        data.earn_fish = 150;
                    }
                    else if (data.league == 3) {
                        data.earn_fish = 200;
                    }
                    else if (data.league == 2) {
                        data.earn_fish = 250;
                    }
                    else if (data.league == 1) {
                        data.earn_fish = 300;
                    }
                    data.result = 1;
                    data.earn_pts = dead_fox;
                    data.gold = data.gold + data.earn_fish;
                    data.gold_overall = data.gold_overall + data.earn_fish;
                    this._app._music.delete_music("all");
                    this._app._so.load_by_name(won_so);
                } else if (dead_cat == 4) {
                    let data = Main.sav.data;
                    data.team_games_1 = data.team_games_1 + 1;;
                    data.team_d_1 = data.team_d_1 + 1;
                    data.team_pts_1 = data.team_pts_1 + dead_fox;
                    var _loc_3 = "team_games_" + this._app.team_enemy_id;
                    var _loc_4 = data["team_games_" + this._app.team_enemy_id] + 1;
                    data[_loc_3] = _loc_4;
                    var _loc_3 = "team_w_" + this._app.team_enemy_id;
                    var _loc_4 = data["team_w_" + this._app.team_enemy_id] + 1;
                    data[_loc_3] = _loc_4;
                    data["team_pts_" + this._app.team_enemy_id] = data["team_pts_" + this._app.team_enemy_id] + dead_cat;
                    data.last_enemy = this._app.team_enemy;
                    data.last_enemy_id = this._app.team_enemy_id;
                ...
                if (data.playoff_round == 1) {
                    data.gold = data.gold + 400;
                    data.gold_overall = data.gold_overall + 400;
                }
                else if (data.playoff_round === 2) {
                    data.gold = data.gold + 800;
                    data.gold_overall = data.gold_overall + 800;
                }
                else if (data.playoff_round == 3) {
                    data.gold = data.gold + 3000;
                    data.gold_overall = data.gold_overall + 3000;
                }
                this.save_results();
                type_end = 1;
                this.end_game();
                ...
                if (data.playoff_round == 1) {
                    ...
                    data.gold_overall = data.gold_overall + 200;
                } else if (data.playoff_round === 2) {
                    data.gold = data.gold + 400;
                    data.gold_overall = data.gold_overall + 400;
                } else if (data.playoff_round == 3) {
                    data.gold = data.gold + 500;
                    data.gold_overall = data.gold_overall + 500;
                }
                this._app._music.delete_music("all");
                this._app._so.load_by_name(defeat_so);
                data.end_of_playoff = 1;
                data.playoff = 0;
                data.rest = 1;
                this.save_results();
                type_end = 2;
        ...
        public end_game() {
            ...
            if (Main.sav.data.playoff == 0) {
                Main.sav.data.season_round = Main.sav.dataseason_round + 1;
            } else {
                Main.sav.data.playoff_round = Main.sav.playoff_round + 1;
            }
            Main.sav.data.week_hi = Main.sav.week_hi + 1;
            if (_loc_1.week_hi > 7) {
                _loc_1.week_hi = 1;
            }
            if (_loc_1.playoff == 0) {
                if (type_end == 1) {
                    ...
                    while (check_won_dress < 5) {
                        ...
                        check_won_dress = check_won_dress + 1;
                    }
                }
            }
            ...
            if (Main.sav.data.playoff == 1) {
                ...
                var new_step = function () {
                    ...
                    if (numbef_of_m == 4 + Main.sav.data.season_koff) {
                        numbef_of_two = true;
                        numbef_of_m = 0;
                        numbef_of_m2 = numbef_of_m2 + 1;
                        if (numbef_of_m2 == 4 + Main.sav.data.season_koff) {
                            numbef_of_m2 = 0;
                        }
                    }
                    numbef_of_m3 = numbef_of_m3 + 1;
                    return;
                }// end function
                    ;
                this.set_match = function () {
                    new_step();
                    i3 = 0;
                ...
                while (i3 < arr_op.length) {
                    ...
                    while (i6 <= 50) {
                        ...
                        if (rnd_for5 >= 4) {
                            let _loc_2 = Main.sav.data;
                            let _loc_3 = "team_w_" + arr_op[i3];
                            let _loc_4 = _loc_2["team_w_" + arr_op[i3]] + 1;
                            _loc_2[_loc_3] = _loc_4;
                            _loc_3 = "team_d_" + arr_op2[i3];
                            _loc_4 = _loc_2["team_d_" + arr_op2[i3]] + 1;
                            _loc_2[_loc_3] = _loc_4;
                            break;
                        }
                        else if (rnd_for6 >= 4) {
                            let _loc_2 = Main.sav.data;
                            let _loc_3 = "team_w_" + arr_op2[i3];
                            let _loc_4 = _loc_2["team_w_" + arr_op2[i3]] + 1;
                            _loc_2[_loc_3] = _loc_4;
                            _loc_3 = "team_d_" + arr_op[i3];
                            _loc_4 = _loc_2["team_d_" + arr_op[i3]] + 1;
                            _loc_2[_loc_3] = _loc_4;
                            break;
                        }
                        i6 = i6 + 1;
                    ...
                    _loc_2[_loc_3] = _loc_4;
                    _loc_3 = "team_games_" + arr_op2[i3];
                    _loc_4 = _loc_2["team_games_" + arr_op2[i3]] + 1;
                    _loc_2[_loc_3] = _loc_4;
        ...
        public add_aura(param1, param2, param3) {
        ...
        public set_injure(param1, param2) {
            if (this._app.train_mode == false) {
        ...
        public add_super_shot(param1, param2) {
        ...
        public add_damage_text(param1, param2, param3) {
        ...
        public click_got_cup_f(event: MouseEvent) {
        ...
        public click_refresh_traning_f(event: MouseEvent) {
            i2 = 0;
            while (i2 < arr_aby.length) {
        ...
        public click_exit_traning_f(event: MouseEvent) {
        ...
        public click_pause_f(event: MouseEvent) {
        ...
        public load_info_to_card(param1, param2) {
        ...
        public tuto_click_f(event: MouseEvent) {
            i = 0;
            while (i < arr_aby.length) {
