    ...
    export class Game extends DataGame {
        ...
        public init(): void {
           ...
           this. _info = new Aby_info();
            this.init_layers();
            this.pause_cl = _sp(pause_mc, zone_tuto, 0, 0);
            this._Buttons_sounds = new Buttons_sounds();
            this._Buttons_sounds.x = 294;
            this._Buttons_sounds.y = 182;
            this.pause_cl.addChild(_Buttons_sounds);
            this.pause_cl.visible = false;
            this.menu_bt_cl = this._sp(menu_bt_mc, zone_panel, 325, 10);
            this.down_panel_cl = this._sp(down_panel_mc, zone_fox, 322, 415);
            this.location_cl = this._sp(location_mc, zone_bg, 0, 0);
            this.info_aby_cl = this._sp(info_aby_mc, zone_panel, 147, 338);
            this.info_aby_cl.visible = false;
            if (Main.sav.data.tuto1 == 1) {
                ...
                addEventListener(egret.Event.ENTER_FRAME, this.tuto1_f);
            }
            else {
            ...
            if (this._app.train_mode == false) {
                ...
                if (Main.sav.data.playoff == 1) {
                    ...
                    if (Main.sav.data.playoff_round == 1) {
                        ...
                        this.grand_cl = _sp(grand_mc, zone_tuto, 325, 180);
        ...
        public game_f(param1: Event): any {
        ...
        public other_f(param1: Event): any {
            i = 0;
        ...
        public click_f(param1: MouseEvent): any {
            i = 0;
            while (i < arr_aby.length) {
                if (arr_aby[i].ex_aby) {
                    if (_mo(arr_aby[i].skin.icon_cl)) {
        ...
        public began_f(param1: Event): any {
            if (status_began == 1) {
                i = 0;
                while (i < arr_cat.length) {
        ...
        public click_back_to_f(param1: MouseEvent): any {
            if (_mo(back_to_cl)) {
        ...
        public grand_f(param1: Event): any {
            if (_frame(grand_cl)) {
        ...
        public click_got_cup_f(param1: MouseEvent): any {
            if (_mo(got_cup_cl.play_cl)) {
                this._app.open_new_screen("playoff");
            }
        }

        public click_refresh_traning_f(param1: MouseEvent): any {
            i2 = 0;
            while (i2 < arr_aby.length) {
                if (arr_aby[i2].ex_aby == false) {
                    arr_aby[i2].reload_time = arr_aby[i2].reload_time2;
        ...
        public click_exit_traning_f(param1: MouseEvent): any {
        ...
        public click_pause_f(param1: MouseEvent): any {
        ...
        public tuto1_f(param1: Event): any {
            rnd_for = 1;
            i = 0;
            while (i < arr_aby.length) {
                if (arr_aby[i].ex_aby == false) {
        ...
        public tuto_click_f(param1: MouseEvent): any {
            i = 0;
            while (i < arr_aby.length) {
                if (arr_aby[i].ex_aby) {
                    if (_mo(arr_aby[i].skin.icon_cl)) {
