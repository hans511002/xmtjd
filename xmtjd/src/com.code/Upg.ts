...
calendar_cl:std.MovieClip;
coach_stay_cl:std.MovieClip;
doctor_cl:std.MovieClip;
dress_bt:SimpleButton;
gong_cl:std.MovieClip;
grass_cl:std.MovieClip;
menu_bt_cl:SimpleButton;
money_tx:TextField;
next_bt:std.MovieClip;
pointer1:std.MovieClip;
pointer2:std.MovieClip;
pointer3:std.MovieClip;
sign_cl:std.MovieClip;
slot_1:std.MovieClip;
slot_2:std.MovieClip;
slot_3:std.MovieClip;
slot_4:std.MovieClip;
stat_bt:SimpleButton;
stat_cl:std.MovieClip;
talk_10:std.MovieClip;
talk_11:std.MovieClip;
talk_12:std.MovieClip;
talk_9:std.MovieClip;
train_1:std.MovieClip;
train_10:std.MovieClip;
train_11:std.MovieClip;
train_12:std.MovieClip;
train_2:std.MovieClip;
train_3:std.MovieClip;
train_4:std.MovieClip;
train_5:std.MovieClip;
train_6:std.MovieClip;
train_7:std.MovieClip;
train_8:std.MovieClip;
train_9:std.MovieClip;
upg_bt:SimpleButton;
upg_cl:std.MovieClip;
zone_1:std.MovieClip;
zone_10:std.MovieClip;
zone_11:std.MovieClip;
zone_12:std.MovieClip;
zone_2:std.MovieClip;
zone_3:std.MovieClip;
zone_4:std.MovieClip;
zone_5:std.MovieClip;
zone_6:std.MovieClip;
zone_7:std.MovieClip;
zone_8:std.MovieClip;
zone_9:std.MovieClip;
zone_drag:std.MovieClip;
zone_tuto:std.MovieClip;
zone_up_all:std.MovieClip;
_app:App;
...
cat_drag:std.MovieClip;
cat_type:number;
set_id:number;
type_zone:number;
injury2:number = 200;
cat_drag_type:number;
arr_temp:any=[];
arr_temp2:any=[];
i7:number;
numbef_of_m:number;
...
paper_cl:std.MovieClip;
result_season_cl:std.MovieClip;
number_of_in:number;
arr_temp3:any=[];
to_battle:number = 0;
...
n_of_treat2:number;
      ...
      public load_to_news(param1:*, param2:*) : *
      {
         if(param1 == 1)
         {
            param1 = 1;
      ...
      public set_to_train(param1:*, param2:*, param3:*) : *
      {
                  ...
                  if(_mo(this.upg_cl["slot_" + i].buy_cl))
                  {
                     if(Main.sav.data.gold >= Main.sav.data["stuff_price_" + i])
                     {
                        if(i < 4 && Main.sav.data["stuff_level_" + i] < 7 || i == 4 && Main.sav.data["stuff_level_" + i] < 5 || i == 5 && Main.sav.data["stuff_level_" + i] < 3)
                        {
                           ...
                           Main.sav.data["stuff_level_" + i]++;
                           this._app._so.load_by_name(buy_so);
                           if(i < 4)
                           {
                              Main.sav.data["stuff_price_" + i] = int(Main.sav.data["stuff_price_" + i] * 1.6);
                           }
                           else if(i == 4)
                           {
                              Main.sav.data["stuff_price_" + i] = int(Main.sav.data["stuff_price_" + i] * 2.5);
                           }
                           else if(i == 5)
                           {
                              Main.sav.data["stuff_price_" + i] = int(Main.sav.data["stuff_price_" + i] * 2.5);
      ...
      public click_paper_f(param1:MouseEvent) : *
      {
      ...
      public click_result_f(param1:MouseEvent) : *
      {
      ...
      public to_battle_f(param1:Event) : *
      {
         ...
         while(i3 <= 4)
         {
            ...
            if(Main.sav.data["cat_place_" + i3] == 1 || Main.sav.data["cat_place_" + i3] == 2)
            {
               ...
               if(Main.sav.data["cat_stat1_" + i3] >= Main.sav.data["cat_stat1_2_" + i3])
               {
                  ...
                  Main.sav.data["cat_attack_level_" + i3]++;
                  Main.sav.data["cat_attack_" + i3]++;
               }
               if(Main.sav.data["cat_attack_level_" + i3] >= 99 || Main.sav.data["cat_hp_" + i3] <= int(Main.sav.data["cat_hp2_" + i3] * 0.25))
               {
                  this.to_table(i3);
               }
            ...
            if(Main.sav.data["cat_place_" + i3] == 3 || Main.sav.data["cat_place_" + i3] == 4)
            {
               ...
               {
                  Main.sav.data["cat_stat2_2_" + i3] = int(Main.sav.data["cat_stat2_2_" + i3] * 1.05);
                  Main.sav.data["cat_stat2_" + i3] = 0;
                  Main.sav.data["cat_hp_level_" + i3]++;
                  Main.sav.data["cat_hp2_" + i3] = Main.sav.data["cat_hp2_" + i3] + 5;
               }
               if(Main.sav.data["cat_hp_level_" + i3] >= 99 || Main.sav.data["cat_hp_" + i3] <= int(Main.sav.data["cat_hp2_" + i3] * 0.25))
               {
                  this.to_table(i3);
               }
            ...
            if(Main.sav.data["cat_place_" + i3] == 5 || Main.sav.data["cat_place_" + i3] == 6)
            {
               ...
               {
                  Main.sav.data["cat_stat3_2_" + i3] = int(Main.sav.data["cat_stat3_2_" + i3] * 1.05);
                  Main.sav.data["cat_stat3_" + i3] = 0;
                  Main.sav.data["cat_speed_level_" + i3]++;
                  Main.sav.data["cat_speed_" + i3] = Main.sav.data["cat_speed_" + i3] - 2;
               }
               if(Main.sav.data["cat_speed_level_" + i3] >= 99 || Main.sav.data["cat_hp_" + i3] <= int(Main.sav.data["cat_hp2_" + i3] * 0.25))
               {
                  this.to_table(i3);
               }
      ...
      public add_train_icon(param1:*, param2:*, param3:*) : *
      {
      ...
      public dress_up2(param1:*, param2:*, param3:*) : *
      {
         param2.head_cl.wool_cl.gotoAndStop(param1);
         param2.hand_l_cl.wool_cl.gotoAndStop(param1);
         param2.hand_r_cl.wool_cl.gotoAndStop(param1);
      ...
      public simulate_day() : *
      {
         ...
         while(i3 < this.arr_op.length)
         {
            ...
            while(i6 <= 50)
            {
               ...
               if(rnd_for5 >= 4)
               {
                  Main.sav.data["team_w_" + this.arr_op[i3]]++;
                  Main.sav.data["team_d_" + this.arr_op2[i3]]++;
                  break;
               }
               if(rnd_for6 >= 4)
               {
                  Main.sav.data["team_w_" + this.arr_op2[i3]]++;
                  Main.sav.data["team_d_" + this.arr_op[i3]]++;
                  break;
               }
               i6++;
            }
            ...
            Main.sav.data["team_games_" + this.arr_op[i3]]++;
            Main.sav.data["team_games_" + this.arr_op2[i3]]++;
      ...
      public tuto2_m_down_f(param1:MouseEvent) : *
      {
         if(this.upg_ex == false && this.stat_ex == false && this.pre_battle_ex == false)
         {
            if(this.drag_mode == false)
      ...
      public tuto2_m_up_f(param1:MouseEvent) : *
      {
         if(this.drag_mode)
         {
            this.yes_new_place = false;
      ...
      public tuto3_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.next_bt))
         {
            this._app._so.load_by_name(next_day_so);
      ...
      public tuto4_click_f(param1:MouseEvent) : *
      {
      ...
      public tuto5_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.next_bt))
         {
            this._app._so.load_by_name(next_day_so);
      ...
      public tuto6_click_f(param1:MouseEvent) : *
      {
         i = 1;
         while(i <= 4)
         {
      ...
      public tuto7_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.next_bt))
         {
            this._app._so.load_by_name(next_day_so);
      ...
      public tuto8_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.gong_cl))
         {
            this.gong_cl.gotoAndPlay(2);
      ...
      public tuto9_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.next_bt))
         {
            this._app._so.load_by_name(next_day_so);
      ...
      public tuto92_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.next_bt))
         {
            this._app._so.load_by_name(next_day_so);
      ...
      public tuto12_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.stat_bt))
         {
            this._app._so.load_by_name(click_so);
      ...
      public tuto14_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.dress_bt))
         {
            this._app._so.load_by_name(click_so);
      ...
      public tuto17_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.upg_bt))
         {
            this.upg_cl.visible = true;
      ...
      public tuto19_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.tuto_cl.ok_bt))
         {
            this._app._so.load_by_name(click_so);
      ...
      public tuto20_m_down_f(param1:MouseEvent) : *
      {
         if(this.upg_ex == false && this.stat_ex == false && this.pre_battle_ex == false)
         {
            if(this.drag_mode == false)
      ...
      public tuto20_m_up_f(param1:MouseEvent) : *
      {
         if(this.drag_mode)
         {
            this.yes_new_place = false;
