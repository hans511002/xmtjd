    ...
    export class Splash extends std.MovieClip {
        ...
        public sp_f(param1: egret.Event): any {
            ...
            if (this.splash_deqaf_cl.currentFrame == this.splash_deqaf_cl.totalFrames) {
                ...
                so1701.load_by_name(Config.SoundRoot + "1701.mp3");
                this["so1701"] = so1701;
                let so1702 = new LoadSounds();
                so1702.load_by_name(Config.SoundRoot + "1702.mp3");
                this["so1702"] = so1702;
            } else if (this.splash_deqaf_cl.currentFrame == 9) {
                let so1706 = new LoadSounds();
                so1706.load_by_name(Config.SoundRoot + "1706.mp3");
                this["so1706"] = so1706;
            } else if (this.splash_deqaf_cl.currentFrame == 33) {
                let so1707 = new LoadSounds();
                so1707.load_by_name(Config.SoundRoot + "1707.mp3");
                this["so1707"] = so1707;
                let so1708 = new LoadSounds();
                so1708.load_by_name(Config.SoundRoot + "1708.mp3");
                this["so1708"] = so1708;
                ...
                so1710.load_by_name(Config.SoundRoot + "1710.mp3");
                this["so1710"] = so1710;
            } else if (this.splash_deqaf_cl.currentFrame == 86) {
                let so1714 = new LoadSounds();
                so1714.load_by_name(Config.SoundRoot + "1714.mp3");
                this["so1714"] = so1714;
                let so1715 = new LoadSounds();
                so1715.load_by_name(Config.SoundRoot + "1715.mp3");
                this["so1715"] = so1715;
            }
        }
        public delete_f(): any {
