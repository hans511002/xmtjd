module com.code {
    export class Splash extends std.MovieClip {
        ...
        public init(): void {
            this.stage.addEventListener(egret.TouchEvent.TOUCH_BEGIN,this.click_f,this);
        ...
        public sp_f(param1: egret.Event): any {
            if(this.splash_deqaf_cl.currentFrame == this.splash_deqaf_cl.totalFrames) {
                ...
                this.stage.removeEventListener(egret.TouchEvent.TOUCH_BEGIN,this.click_f,this);
