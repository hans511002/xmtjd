module com.code
{
    export class Dress extends DataMovieClip
    {
        ...
        public init(): void{
            ...
            this.set_sort(1);
            this.set_page(1);
            this.card1_about = this._sp(card_mc,this.zone_cards_about,mouseX,mouseY);
            this.load_info_to_card(this.card1_about,1,1,2);
            this.card1_about.$setVisible(false);
            this.card2_about = this._sp(card_mc,this.zone_cards_about,mouseX,mouseY);
            this.load_info_to_card(this.card2_about,1,1,2);
            this.card2_about.$setVisible(false);
            this.card3_about = this._sp(card_mc,this.zone_cards_about,mouseX,mouseY);
            this.load_info_to_card(this.card3_about,1,1,2);
            this.card3_about.$setVisible(false);
            this.card4_about = this._sp(card_mc,this.zone_cards_about,mouseX,mouseY);
                        ...
                        if(_mo(this.panel_cl["card_" + i].telo)){
                            if(this.panel_cl["card_" + i].currentFrame != 3){
                                if(this.panel_cl["card_" + i].wear_cl.visible == false){
                                    ...
                                    this.panel_cl["card_" + i].$setVisible(false);
