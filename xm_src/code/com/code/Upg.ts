module com.code
{
    export class Upg extends DataMovieClip
    {
        ...
        public dress_bt: std.MCSimpleButton = null;
        ...
        public stat_bt: std.MCSimpleButton = null;
        ...
        public upg_bt: std.MCSimpleButton = null;
        ...
        public click_result_f(param1: egret.TouchEvent): any{
            if(_mo(this.result_season_cl)){
                ...
                if(Main.sav.data.tuto2 == 1){
                    ...
                    this.stage.addEventListener(MouseEvent.MOUSE_DOWN,this.tuto2_m_down_f,this);
                    this.stage.addEventListener(MouseEvent.MOUSE_UP,this.tuto2_m_up_f,this);
                }
                else{
                    this.add_tuto4();
                }
        ...
        public tuto2_f(param1: egret.Event): any{
            ...
            if(this.ex2_in_place(9) == 0 && this.ex2_in_place(10) == 0 && this.ex2_in_place(11) == 0 && this.ex2_in_place(12) == 0){
                ...
                this.stage.removeEventListener(MouseEvent.MOUSE_DOWN,this.tuto2_m_down_f,this);
                this.stage.removeEventListener(MouseEvent.MOUSE_UP,this.tuto2_m_up_f,this);
        ...
        public tuto5_click_f(param1: egret.TouchEvent): any{
            if(_mo(this.next_bt)){
                ...
                this.stage.addEventListener(MouseEvent.MOUSE_DOWN,this.tuto6_click_f,this);
        ...
        public tuto6_f(param1: egret.Event): any{
            if(this.ex2_in_place(9) == 0 && this.ex2_in_place(10) == 0 && this.ex2_in_place(11) == 0 && this.ex2_in_place(12) == 0){
                ...
                this.stage.removeEventListener(MouseEvent.MOUSE_DOWN,this.tuto6_click_f,this);
        ...
        public tuto19_click_f(param1: egret.TouchEvent): any{
            if(_mo(this.tuto_cl.ok_bt)){
                ...
                this.stage.addEventListener(MouseEvent.MOUSE_DOWN,this.tuto20_m_down_f,this);
                this.stage.addEventListener(MouseEvent.MOUSE_UP,this.tuto20_m_up_f,this);
            }
        }
        public tuto20_f(param1: egret.Event): any{
            ...
            if(this.ex2_in_place(9) == 0 && this.ex2_in_place(10) == 0 && this.ex2_in_place(11) == 0 && this.ex2_in_place(12) == 0){
                ...
                this.stage.removeEventListener(MouseEvent.MOUSE_DOWN,this.tuto20_m_down_f,this);
                this.stage.removeEventListener(MouseEvent.MOUSE_UP,this.tuto20_m_up_f,this);
            }
        }
