package com.code
{
   ...
   public class Upg extends DataMovieClip
   {
      ...
      function drag_m_down_f(param1:MouseEvent) : *
      {
      ...
      function drag_m_up_f(param1:MouseEvent) : *
      {
         if(this.drag_mode)
         {
      ...
      function click_paper_f(param1:MouseEvent) : *
      {
      ...
      function click_result_f(param1:MouseEvent) : *
      {
      ...
      function to_battle_f(param1:Event) : *
      {
      ...
      function tuto2_m_down_f(param1:MouseEvent) : *
      {
         if(this.upg_ex == false && this.stat_ex == false && this.pre_battle_ex == false)
         {
            if(this.drag_mode == false)
      ...
      function tuto2_m_up_f(param1:MouseEvent) : *
      {
         if(this.drag_mode)
         {
            this.yes_new_place = false;
      ...
      function tuto3_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.next_bt))
         {
            this._app._so.load_by_name(next_day_so);
      ...
      function tuto4_click_f(param1:MouseEvent) : *
      {
      ...
      function tuto5_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.next_bt))
         {
            this._app._so.load_by_name(next_day_so);
      ...
      function tuto6_click_f(param1:MouseEvent) : *
      {
         i = 1;
         while(i <= 4)
         {
      ...
      function tuto7_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.next_bt))
         {
            this._app._so.load_by_name(next_day_so);
      ...
      function tuto8_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.gong_cl))
         {
            this.gong_cl.gotoAndPlay(2);
      ...
      function tuto9_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.next_bt))
         {
            this._app._so.load_by_name(next_day_so);
      ...
      function tuto92_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.next_bt))
         {
            this._app._so.load_by_name(next_day_so);
      ...
      function tuto12_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.stat_bt))
         {
            this._app._so.load_by_name(click_so);
      ...
      function tuto13_f(param1:Event) : *
      {
      ...
      function tuto14_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.dress_bt))
         {
            this._app._so.load_by_name(click_so);
      ...
      function tuto17_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.upg_bt))
         {
            this.upg_cl.visible = true;
      ...
      function tuto18_f(param1:Event) : *
      {
      ...
      function tuto19_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.tuto_cl.ok_bt))
         {
            this._app._so.load_by_name(click_so);
      ...
      function tuto20_f(param1:Event) : *
      {
         if(this.drag_mode)
         {
            this.cat_drag.x = mouseX;
      ...
      function tuto20_m_down_f(param1:MouseEvent) : *
      {
         if(this.upg_ex == false && this.stat_ex == false && this.pre_battle_ex == false)
         {
            if(this.drag_mode == false)
      ...
      function tuto20_m_up_f(param1:MouseEvent) : *
      {
         if(this.drag_mode)
         {
            this.yes_new_place = false;
