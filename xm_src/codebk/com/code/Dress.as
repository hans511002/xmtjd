package com.code
{
   ...
   public class Dress extends DataMovieClip
   {
      ...
      function tuto21_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.shop_bt))
         {
            this.shop_cl.visible = true;
      ...
      function tuto22_click_f(param1:MouseEvent) : *
      {
         i = 1;
         while(i <= 1)
         {
      ...
      function tuto23_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.shop_cl.close_bt))
         {
            this.shop_cl.visible = false;
      ...
      function tuto15_click_f(param1:MouseEvent) : *
      {
      ...
      function tuto16_f(param1:Event) : *
      {
         if(this.drag_mode)
         {
            this.card_cl.x = mouseX;
      ...
      function tuto24_click_f(param1:MouseEvent) : *
      {
         if(_mo(this.back_bt))
         {
