...
*/
		addMCbs(mcs:MovieClipSubBase, reinit:number=0):void 
		{
			if(reinit)
...
//所有全部子集群,用于自动删除
		mcs:Array<MovieClipSub>;
		mcbs:Array<MovieClipSubBase>;
